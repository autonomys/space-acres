...
running_node_low_disk_space_warning = Low disk space! Only {$size} remaining. Consider moving node data to a drive with more space.
running_node_move_data_button = Move Data
running_node_move_data_dialog_title = Move Node Data
running_node_move_data_dialog_message = Select a new location with more free space for your node data. The current data will be moved to the new location.
running_node_move_data_in_progress = Moving node data to new location...
running_node_move_data_success = Node data moved successfully. Please restart the application.
running_node_move_data_error = Failed to move node data: {$error}
...
stopped_message_disk_space_error = Node stopped due to insufficient disk space. Move your data to a drive with more space to continue.
stopped_button_show_logs = Show logs
stopped_button_help_from_community = Help from community
stopped_button_move_data = Move Node Data
