...
loading_farmer_title = Создание фармера
loading_farmer_step_initializing = Инициализация фармов {$index}/{$farms_total}...
loading_farmer_step_created_successfully = Фармер создан успешно
loading_wiping_farmer_data_title = Удаление данных фармера
loading_wiping_farmer_data_step_wiping_farm = Удаление фарма {$index}/{$farms_total} at {$path}...
loading_wiping_farmer_data_step_success = Все фармы удалены успешно
...
configuration_farm = Путь к фарму {$index} и его размер
configuration_farm_path_placeholder = Пример: {$path}
configuration_farm_path_tooltip = Абсолютный путь к папке, в которой будут храниться данные фарма. Подойдет любой SSD-накопитель, высокая производительность не требуется
...
configuration_farm_fixed_size_tooltip = Размер фарма в зависимости от того, какие единицы измерения вы предпочитаете. Подойдет любой размер свыше 2Гб
configuration_farm_free_percentage_size_placeholder = Пример: 100%, 1.1%, и т.д.
configuration_farm_free_percentage_size_tooltip = Процент свободного места на диске, занимаемого фармом. Будет работать от 0%, но на диске должно оставаться не менее 2Гб свободного места для исключения ошибок.
configuration_farm_delete = Удалить этот фарм
configuration_advanced = Расширенная конфигурация
configuration_advanced_farmer = Конфигурация фармера
configuration_advanced_farmer_reduce_plotting_cpu_load = Уменьшить нагрузку на процессор при плоттинге фармов
configuration_advanced_farmer_reduce_plotting_cpu_load_tooltip = Первичный плоттинг использует все ядра процессора по умолчанию. При использовании этой опции, для плоттинга используется половина ядер процессора, что повысит скорость реагирования системы на другие задачи
