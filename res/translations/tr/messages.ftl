...
loading_farmer_title = Madenci başlatılıyor
loading_farmer_step_initializing = Madenler Başlatılıyor {$index}/{$farms_total}...
loading_farmer_step_created_successfully = Madenler başarıyla oluşturuldu
loading_wiping_farmer_data_title = Madenci Verileri Temizleniyor
loading_wiping_farmer_data_step_wiping_farm = Madenlerler {$index}/{$farms_total} konumunda temizleniyor {$path}...
loading_wiping_farmer_data_step_success = Tüm madenler başarıyla temizlendi
...
configuration_farm_delete = Bu madeni sil
...
configuration_button_add_farm = Maden Ekle
