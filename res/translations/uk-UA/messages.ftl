...
configuration_node_migrate_button = Мігрувати...
...
node_migration_mode_migrate_explanation = Переміщує наявну базу даних у нове місце. Потребує достатньо вільного місця в місці призначення для поточної бази даних.
node_migration_mode_reset = Скинути та пересинхронізувати на місці
...
node_migration_non_node_data_warning = Примітка: У цій директорії виявлено дані, що не належать вузлу, і вони не будуть перенесені
...
notification_farm_error = Одна з ферм зазнала невдачі в Space Acres
    .body = Сталася помилка яка вимагає втручання користувача для її вирішення
notification_node_low_disk_space = Мало вільного простору на диску вузла
...
warning_low_disk_space = Мало вільного простору на диску вузла
warning_low_disk_space_detail = Залишилось лише {$free_space}. Розгляньте можливість міграції на диск більшого розміру.
